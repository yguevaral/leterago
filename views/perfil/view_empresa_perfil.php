    ...
    public function drawListaEmpresas($lista_empresas) {
        ...
        <script>
            function agregarEmpresa(id, nombre) {
                ...
                $.ajax({
                    url: "<?= base_url ?>perfil/&getAddArray=true&key=2&id=" + id + "&nombreEmpresa=" + nombre,
    ...
    public function drawEmpresaByCodigo($id, $nombre) {
        ...
        <div class="col-md-5">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="txt_nombreEmpresa" value="<?= $nombre; ?>" required/>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="txt_perfil" required/>
            </div>
        </div>
        <?php
    }
